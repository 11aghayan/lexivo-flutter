...
class GrammarSubmenu {
    ...
    GrammarSubmenu.create(this.header, this.explanations, this.examples) : id = Uuid().v4();
      
  // JSON
  factory GrammarSubmenu.fromJson(Map<String, dynamic> json) => _$GrammarSubmenuFromJson(json);
